...
def generic_plan_chat(payload):
    ...
    if success_reply:
        policy += ('\nAn action plan may include optional on_success_reply: a short final reply to deliver ONLY '
    ...
    success_text = response['call']['arguments'].get('on_success_reply') if success_reply and call['name']=='plan' else None
