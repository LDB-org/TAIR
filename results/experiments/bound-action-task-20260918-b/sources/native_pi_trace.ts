...
export default function(pi: any) {
  ...
  pi.on('before_provider_request', (event: any) => {
    ...
    const payload = { ...event.payload, temperature: 0, max_tokens: 2048, parallel_tool_calls: false,
      cache_salt: id, chat_template_kwargs: { thinking: false, enable_thinking: false } };
