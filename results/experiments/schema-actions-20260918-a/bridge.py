...
def locked_edit(path, task, cwd, directory):
    ...
    with stage('admission'):
        ...
        trace_update(cache_hit=hit and not schema_mode, schema_hit=hit and schema_mode, validation=verification)
    return {'path': str(path), 'applied': True, 'cache_hit': hit and not schema_mode, 'schema_hit': hit and schema_mode, 'admitted': admitted,
