...
def attempt(project, state, folder, arm, value, timeout, scenario=None, env_overrides=None):
    ...
    (folder / 'after.py').write_bytes((project / 'app.py').read_bytes() if (project / 'app.py').is_file() else b'')
