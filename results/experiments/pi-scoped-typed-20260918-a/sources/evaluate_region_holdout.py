...
def attempt(folder,payload,source,regions,pristine,check,case,mode,host,line_protocol=False,structural_protocol=False,compact_protocol=False,typed_protocol=False,scoped_protocol=False):
 ...
 try:
  ...
  if mode=='native':
   ...
   if typed_protocol:
    ...
    updated=compact.typed_decode(source,structural.digest(source),message.get('content') or '',choice['finish_reason'],allowed)
