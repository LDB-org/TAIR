    ...
    try:
        with tempfile.TemporaryDirectory(prefix='tair-expanded-project-') as temp:
            ...
            for task_id,arm in schedule:
                ...
                overrides['PIJIT_PLAN_DISABLE_REUSE']='1' if arm in ('tair_no_reuse','tair_reply','tair_recovery','tair_capcache','tair_argv','tair_parallel_caps','tair_reply_branch','tair_combined_no_reuse','tair_dedup') else '0'
                ...
                try:
                    ...
                    if arm!='native':
                        ...
                        assert chats and all(m.get('plan_reuse_enabled')==(arm not in ('tair_no_reuse','tair_reply','tair_recovery','tair_capcache','tair_argv','tair_parallel_caps','tair_reply_branch','tair_combined_no_reuse','tair_dedup')) for m in chats), 'Runtime reuse configuration mismatch'
