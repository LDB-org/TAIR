...
def main(out, continuation=False, task_ids=None, fresh=False, local_tokenizer=None, verify_tokenizer=False, prefix_cache=False, compact_catalog=False, reuse_routing=False, ssh_compression=False, ablation=False, empty_book=False, success_reply_ablation=False, recovery_latest=False, recovery_ablation=False, capabilities_ablation=False, execution_ablation=False):
    ...
    if success_reply_ablation or recovery_ablation or capabilities_ablation or execution_ablation:
        ablation = True
    cli = shutil.which('pi')
    if not cli:
    ...
    manifest['reuse_ablation'] = ablation and not success_reply_ablation and not recovery_ablation and not capabilities_ablation and not execution_ablation
...
if __name__=='__main__':
    ...
    args=p.parse_args();main(args.out,args.continuation,args.tasks,args.fresh,args.local_tokenizer,args.verify_tokenizer,args.prefix_cache,args.compact_catalog,args.reuse_routing,args.ssh_compression,args.ablation,args.empty_book,args.success_reply_ablation,args.recovery_latest,args.recovery_ablation,args.capabilities_ablation,args.execution_ablation)
