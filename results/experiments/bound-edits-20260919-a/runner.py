...
out=root/'results/experiments/bound-edits-20260919-a'
...
try:
    ...
    result=subprocess.run(['/tmp/tair-test-venv-20260918/bin/python',str(root/'benchmarks/benchmark_bound_edits.py'),'--url',f'http://127.0.0.1:{port}','--out',str(out),'--repeats','3'],cwd=root)
