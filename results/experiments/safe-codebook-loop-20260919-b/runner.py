...
out=root/'results/experiments/safe-codebook-loop-20260919-b'
...
try:
    ...
    result=subprocess.run(['/tmp/tair-test-venv-20260918/bin/python',str(root/'benchmarks/benchmark_safe_codebook.py'),'--url',f'http://127.0.0.1:{port}','--out',str(out),'--repeats','2'],cwd=root)
