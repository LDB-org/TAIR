...
def main(out, host, repeats, readable=False, examples=False, selected=None, multi=False, batch_only=False):
    ...
    for repeat in range(repeats):
        for case,task in cases.items():
            ...
            for mode in (['native',region_mode] if repeat%2==0 else [region_mode,'native']):
...
if __name__=='__main__':
    ...
    main(a.out,a.host,a.repeats,a.readable_regions,a.examples,a.cases,a.multi,a.batch_only)
