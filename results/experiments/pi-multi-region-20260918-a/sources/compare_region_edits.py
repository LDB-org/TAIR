...
def main(out, host, repeats, readable=False, examples=False, selected=None, multi=False):
...
if __name__=='__main__':
    ...
    main(a.out,a.host,a.repeats,a.readable_regions,a.examples,a.cases,a.multi)
