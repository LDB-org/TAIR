...
def main(out, continuation=False, task_ids=None, fresh=False, local_tokenizer=None, verify_tokenizer=False, prefix_cache=False, compact_catalog=False, reuse_routing=False, ssh_compression=False):
    cli = shutil.which('pi')
    if not cli:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix='tair-expanded-project-') as temp:
            ...
            for task_id,arm in schedule:
                ...
                if arm == 'tair' and local_tokenizer:
                ...
                if arm == 'tair' and reuse_routing:
                    overrides['PIJIT_REUSE_ROUTING']='1'
                if arm == 'tair' and compact_catalog:
                    overrides['PIJIT_COMPACT_CATALOG']='1'
                if arm == 'tair' and prefix_cache:
...
if __name__=='__main__':
    ...
    args=p.parse_args();main(args.out,args.continuation,args.tasks,args.fresh,args.local_tokenizer,args.verify_tokenizer,args.prefix_cache,args.compact_catalog,args.reuse_routing,args.ssh_compression)
