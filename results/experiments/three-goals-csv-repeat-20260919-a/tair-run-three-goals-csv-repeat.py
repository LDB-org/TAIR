...
with subprocess.Popen(command,stdout=subprocess.DEVNULL,stderr=subprocess.PIPE,text=True) as tunnel:
 try:
  ...
  subprocess.run(['/tmp/tair-test-venv-20260918/bin/python','-u','benchmarks/benchmark_three_goals.py','--url',url,'--out','results/experiments/three-goals-csv-repeat-20260919-a','--timeout','120','--cases','quoted_csv','--repeats','3','--rounds','1','--arms','native_multi','tair','hybrid','--tokenizer-revision','c90dfa01249db1be4245780a052ede752e1361c612ac6d08e2bdada7d599476b:6ac8c8dc065ed118161d02dd532749ae3f52c243deac27872134fae2f50d8547'],env=env,check=True)
 finally:
  tunnel.terminate()
