...
def main(out,host,repeats,line_protocol=False,structural_protocol=False,selected=None,semantic_targets=False):
...
if __name__=='__main__':
 ...
 main(a.out,a.host,a.repeats,a.line_protocol,a.structural_protocol,a.cases,a.semantic_targets)
