    ...
    try:
        with tempfile.TemporaryDirectory(prefix='tair-expanded-project-') as temp:
            ...
            for task_id,arm in schedule:
                ...
                overrides['PIJIT_FIRST_TOOL_CLASSIFICATION']='0' if arm=='tair_general' else '1'
                ...
                try:
                    ...
                    if arm!='native':
                        ...
                        assert all(m.get('first_tool_classification_enabled')==(arm!='tair_general') for m in chats), 'Runtime first-tool classification mismatch'
