...
def run(args):
    ...
    for relative in ['deploy/adaptive_plan.py','deploy/plan_book.py','deploy/vllm_direct_tools.py','deploy/tool_plan.py','integrations/pijit/plan_executor.mjs','integrations/pijit/plan_metrics.mjs','integrations/pijit/bridge.py','integrations/pijit/extension.ts','deploy/native_planner.py',
