...
def totals(text):
    ...
    Returns a dict mapping category name to the sum of its integer amounts.
    Empty text or header-only input returns {}.
    Raises ValueError if any amount is not a valid integer.
    """
    ...
    # Normalize header names (strip whitespace) and find column indices.
