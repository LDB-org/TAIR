...
def run(args):
    ...
    manifest = {'seed': 20260918, 'repeats': args.repeats, 'preparation_seconds': preparation,
                'scope': 'Ideal explicit named lookup among four complete actions, not natural-language coding ability. Both arms see identical candidates; only output instructions and output mechanism differ. No grammar constraint on generated JSON.',
