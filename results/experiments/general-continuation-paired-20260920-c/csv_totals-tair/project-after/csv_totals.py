...
def totals(text):
    ...
    The CSV must have a header with columns category,amount. Quoted commas
    in category names, negative numbers and Unicode are supported. Empty
    text or header-only input returns {}. An invalid amount raises
    ValueError.
    """
