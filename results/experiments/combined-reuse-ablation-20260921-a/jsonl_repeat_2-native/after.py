...
def parse_jsonl(text):
    ...
    Each remaining line is decoded with :func:`json.loads`; a malformed
    line raises :class:`ValueError`.  Duplicate object keys follow the
    standard ``json.loads`` behavior (the last value wins).
    """
    results = []
