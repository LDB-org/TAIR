...
def parse_jsonl(text):
    ...
    in line order.  Whitespace-only lines are skipped.  A final line without
    a trailing newline is handled.  Both ``\\n`` and ``\\r\\n`` line endings
    are supported, and Unicode content is decoded normally.
