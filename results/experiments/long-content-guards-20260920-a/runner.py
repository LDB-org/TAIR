...
run='long-content-guards-20260920-a';out=ROOT/'results/experiments'/run;out.mkdir(exist_ok=False)
...
env.update(PIJIT_PLAN_TEMPLATES='0',PIJIT_STATE_DIR=str(state),PIJIT_SSH_HOST='rs-yuesheng-gpu-public',PIJIT_PYTHON=sys.executable)
