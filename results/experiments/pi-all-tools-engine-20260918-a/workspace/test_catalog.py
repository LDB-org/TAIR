...
class CleanNamesTests(unittest.TestCase):
    ...
    def test_duplicates_after_trimming_are_removed_preserving_order(self):
        self.assertEqual(clean_names([' Ada ', 'Ada', ' Bob ', 'Bob', '  Ada  ']), ['Ada', 'Bob'])

    def test_order_is_preserved(self):
        self.assertEqual(clean_names([' z ', ' a ', ' m ']), ['z', 'a', 'm'])
