...
def summarize(root):
 ...
 result['limitations']=f'{len(cases)} related tasks, shared server, task-test oracle fallback, single-edit workflow; screening only, no production or stable speed claim'
