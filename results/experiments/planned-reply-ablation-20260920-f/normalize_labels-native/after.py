...
def unique_labels(values: List[str]) -> List[str]:
    ...
    Each value is normalized by stripping leading/trailing whitespace and applying
    Unicode casefold. Empty normalized keys are discarded. The original unmodified
