...
def main(out):
 ...
 tokenized=b.remote('rs-yuesheng-gpu-vps',requests)['results']
 ...
 for case,arm in jobs:
  ...
  result=b.remote('rs-yuesheng-gpu-vps',[('/v1/completions',body)]);item=result['results'][0];assert item['status']==200,item
