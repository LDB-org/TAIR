...
with subprocess.Popen(command,stdout=subprocess.DEVNULL,stderr=subprocess.PIPE,text=True) as tunnel:
 try:
  ...
  subprocess.run(['/tmp/tair-test-venv-20260918/bin/python','-u','benchmarks/benchmark_file_io.py','--url',url,'--out','results/experiments/file-io-20260919-a','--timeout','180','--tokenizer-revision','c90dfa01249db1be4245780a052ede752e1361c612ac6d08e2bdada7d599476b:6ac8c8dc065ed118161d02dd532749ae3f52c243deac27872134fae2f50d8547'],env=env,check=True)
 finally:
  tunnel.terminate()
