...
if __name__=='__main__':
 p=argparse.ArgumentParser(description=__doc__);p.add_argument('--out',required=True,type=Path);p.add_argument('--host',default=os.environ.get('ENGINE_TOOLCALL_HOST', 'localhost'));p.add_argument('--repeats',type=int,default=2)
