...
def generic_plan_chat(payload):
    ...
    native_fallback = os.environ.get('PIJIT_NATIVE_FALLBACK') == '1' and not recovery
    trace_update(native_fallback_enabled=native_fallback)
    ...
    trace_update(native_fallback_used=bool(branch.startswith('tool:') and 'steps' in wire_arguments))
